...
*/		return mobile;
	...
	private static Application createApplication0(String appId, int userId){
		...
		if(EEG_TRANSMISSION_TIME==10)
			application.addAppEdge("EEG", "client", 0, 2000, 500, "EEG", Tuple.UP, AppEdge.SENSOR); // adding edge from EEG (sensor) to Client module carrying tuples of type EEG
		else
			application.addAppEdge("EEG", "client", 0, 3000, 500, "EEG", Tuple.UP, AppEdge.SENSOR);
	...
	private static Application createApplication1(String appId, int userId){
		 ...
		 */
		if(EEG_TRANSMISSION_TIME==10)
			application.addAppEdge("EEG_1", "client_1", 0, 2000, 500, "EEG_1", Tuple.UP, AppEdge.SENSOR); // adding edge from EEG (sensor) to Client module carrying tuples of type EEG
		else
			application.addAppEdge("EEG_1", "client_1", 0, 3000, 500, "EEG_1", Tuple.UP, AppEdge.SENSOR);
		application.addAppEdge("client_1", "concentration_calculator_1", 0, 3500, 500, "_SENSOR_1", Tuple.UP, AppEdge.MODULE); // adding edge from Client to Concentration Calculator module carrying tuples of type _SENSOR
		...
		application.addAppEdge("concentration_calculator_1", "client_1", 0, 14, 500, "CONCENTRATION_1", Tuple.DOWN, AppEdge.MODULE);  // adding edge from Concentration Calculator to Client module carrying tuples of type CONCENTRATION
		...
		application.addAppEdge("client_1", "DISPLAY_1", 0, 1000, 500, "SELF_STATE_UPDATE_1", Tuple.DOWN, AppEdge.ACTUATOR);  // adding edge from Client module to Display (actuator) carrying tuples of type SELF_STATE_UPDATE
		application.addAppEdge("client_1", "DISPLAY_1", 0, 1000, 500, "GLOBAL_STATE_UPDATE_1", Tuple.DOWN, AppEdge.ACTUATOR);  // adding edge from Client module to Display (actuator) carrying tuples of type GLOBAL_STATE_UPDATE
