...
public class TxtParser {
    ...
    int insDirection = 1;
		...
		EdgeSpec e = addEdge(insParent, insChild, insTupleType, insPeriodicity, insCpuLength, insNwLength, insEdgeType, insDirection);
    ...
    public void createModuleTopology(String moduleLine) throws NumberFormatException, IOException {
		...
		ModuleSpec m = addModule(insNodeName, insModuleName, insRam, insBandwidth, insInTuple, insOutTuple, insSize, insMIPS, insFractionalSensitivity);
   }
	...
	public EdgeSpec addEdge(String parent, String child, String tupleType, double periodicity, double cpuLength, double newLength, String edgeType, int direction) {
	...
	public ModuleSpec addModule(String nodeName, String moduleName, int modRam, long bandwidth, String inTuple, String outTuple, long size, int MIPS, double fractionalSensitivity) {
		ModuleSpec module = new ModuleSpec(nodeName, moduleName, modRam, bandwidth, inTuple, outTuple, size, MIPS, fractionalSensitivity);
		modules.add(module);
		return module;
	}
	...
	class EdgeSpec {
		...
		public EdgeSpec(String parent, String child, String tupleType, double periodicity, double cpuLength, double newLength, String edgeType, int direction) {			
			this.parent = parent;
			this.child = child;
	...
	class ModuleSpec {
		...
		public ModuleSpec(String nodeName, String moduleName, int modRam, long bandwidth, String inTuple, String outTuple, long size, int MIPS, double fractionalSensitivity) {			
	...
	public void writeJSON(String jsonFileName) {
		...
		for(ModuleSpec m:modules) moduleList.add(m.toJSON());
